...
> 当前公开开发状态：36 只首发名单已锁定。第一波 8 只均已完成并通过 Codex Pet V2 工程 QA。承太郎已经发布；其余 7 只在开放公开安装按钮前仍等待站长最终动画审核。第 1–2 部四只的基础造型已于 2026-07-19 通过，并已安装到站长本机 Codex 供体验。
...
首发名单共 36 只，分三波通过质量门发布。详见[完整名单](../headline-roster.md)、[第一波进度](../wave-1-status.md)与[第 1–2 部动画审核](../visual/wave-1-animation-review/README.md)。

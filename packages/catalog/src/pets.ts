...
export const pets: readonly Pet[] = [
  ...
  { id: "part-03-jotaro-kujo", part: 3, name: { en: "Jotaro Kujo", "zh-CN": "空条承太郎" }, type: "character", role: "protagonist", status: "pilot-review", source, pairIds: ["part-03-star-platinum"], image: "/pilot-bases/part-03-jotaro-kujo.png", palette: ["#171a33", "#7ed6c4", "#ff6b6b", "#e8c66a"] },
